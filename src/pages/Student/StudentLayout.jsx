    ...
    <aside className="w-full h-full bg-white flex flex-col justify-between py-6">
      <div className="flex flex-col">
        <ul className="flex flex-col gap-2">
          <li>
            <NavLink to="/student/home" className={navClass}>
          ...
          <li>
            <NavLink to="/student/leaders" className={navClass}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
          ...
          <li>
            <NavLink to="/student/rules" className={navClass}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
          ...
          <li>
            <NavLink to="/student/complain" className={navClass}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
  ...
  return (
    <div className="h-full flex items-center justify-between px-6">
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs font-bold text-slate-400 bg-slate-100 px-2 py-0.5 rounded-full">O'quvchi</span>
      </div>
      <div className="flex items-center gap-3">
